...
class CheckoutAddress extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.currentCustomer !== undefined) {
      if (
        nextProps.currentCustomer.customer !== undefined &&
            ...
            <View style={Styles.shippingMethodsWrap}>
              ...
              <View style={Styles.shippingMethodsList}>
                {shippingMethods &&
                  ...
                  shippingMethods.data.map((item, index) => {
    ...
    if (formIsValid === 1) {
      if (selectedShippingMethod.id !== 0) {
        ...
        const shipping = {
          ...
          shippingCost: selectedShippingMethod.settings.cost
            ? parseInt(selectedShippingMethod.settings.cost.value)
            : 0,
        };
