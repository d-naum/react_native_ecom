...
import SearchButton from '../src/theme/searchButton'
import styles from '../src/views/category/style'
import MenuButton from '../src/theme/menuButton'
                    ...
                    return (
                        !item ? null :
                            <TouchableOpacity key={index}
                                ...
                                onPress={() => { console.log('hello'); navigation.push('CategoryProductsScreen', { item }) }}>
